...
--Converting SaleDate field to the datatype 'date'
...
--Populating the Property Address data by using self join and removing the nulls
...
--Splitting PropertyAddress field into Address and City fields
...
--Splitting OwnerAddress field into OwnerSplitAddress, OwnerSplitCity & OwnerSplitState fields
...
--Changing SoldAsVacant field values from 'Y' to 'Yes' and from 'N' to 'No'
